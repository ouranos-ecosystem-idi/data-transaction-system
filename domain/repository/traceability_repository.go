...
type (
	TraceabilityRepository interface {
		...
		PostPartsStructures(c echo.Context, request traceabilityentity.PostPartsStructuresRequest) (traceabilityentity.PostPartsStructuresResponse, error)
		// 依頼情報検索API
		...
		// 依頼情報登録API
		PostTradeRequests(c echo.Context, request traceabilityentity.PostTradeRequestsRequest) (traceabilityentity.PostTradeRequestsResponses, error)
		// 依頼取消登録API
		PostTradeRequestsCancel(c echo.Context, request traceabilityentity.PostTradeRequestsCancelRequest) (traceabilityentity.PostTradeRequestsCancelResponse, error)
		// 依頼差戻登録API
		PostTradeRequestsReject(c echo.Context, request traceabilityentity.PostTradeRequestsRejectRequest) (traceabilityentity.PostTradeRequestsRejectResponse, error)
		// 受領依頼情報検索API
		// CFP情報取得API
		...
		// CFP情報登録API
		PostCfp(c echo.Context, requests traceabilityentity.PostCfpRequest) (traceabilityentity.PostCfpResponses, error)
		// CFP証明書情報検索API
		...
		// 部品情報紐づけ登録API
		PostTrades(c echo.Context, request traceabilityentity.PostTradesRequest) (traceabilityentity.PostTradesResponse, error)
	}
)
