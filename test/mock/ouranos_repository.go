...
func (_m *OuranosRepository) CountPartsList(getPlantPartsModel traceability.GetPartsModel) (int, error) {
	ret := _m.Called(getPlantPartsModel)

	var r0 int
	var r1 error
	if rf, ok := ret.Get(0).(func(traceability.GetPartsModel) (int, error)); ok {
		return rf(getPlantPartsModel)
	}
	if rf, ok := ret.Get(0).(func(traceability.GetPartsModel) int); ok {
...
// GetPartsStructure provides a mock function with given fields: getPartsStructureModel
func (_m *OuranosRepository) GetPartsStructure(getPartsStructureModel traceability.GetPartsStructureModel) (traceability.PartsStructureEntity, error) {
	ret := _m.Called(getPartsStructureModel)

	var r0 traceability.PartsStructureEntity
	var r1 error
	if rf, ok := ret.Get(0).(func(traceability.GetPartsStructureModel) (traceability.PartsStructureEntity, error)); ok {
		return rf(getPartsStructureModel)
	}
	if rf, ok := ret.Get(0).(func(traceability.GetPartsStructureModel) traceability.PartsStructureEntity); ok {
		r0 = rf(getPartsStructureModel)
	} else {
		r0 = ret.Get(0).(traceability.PartsStructureEntity)
	}

	if rf, ok := ret.Get(1).(func(traceability.GetPartsStructureModel) error); ok {
...
func (_m *OuranosRepository) ListParts(getPlantPartsModel traceability.GetPartsModel) (traceability.PartsModelEntities, error) {
	ret := _m.Called(getPlantPartsModel)

	var r0 traceability.PartsModelEntities
	var r1 error
	if rf, ok := ret.Get(0).(func(traceability.GetPartsModel) (traceability.PartsModelEntities, error)); ok {
		return rf(getPlantPartsModel)
	}
	if rf, ok := ret.Get(0).(func(traceability.GetPartsModel) traceability.PartsModelEntities); ok {
		r0 = rf(getPlantPartsModel)
	} else {
		if ret.Get(0) != nil {
...
func (_m *OuranosRepository) PutStatusCancel(statusID string, operatorID string) (traceability.StatusEntityModel, error) {
	ret := _m.Called(statusID, operatorID)

	var r0 traceability.StatusEntityModel
	var r1 error
	if rf, ok := ret.Get(0).(func(string, string) (traceability.StatusEntityModel, error)); ok {
		return rf(statusID, operatorID)
	}
	if rf, ok := ret.Get(0).(func(string, string) traceability.StatusEntityModel); ok {
